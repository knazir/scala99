...
object Main {
  ...
  val ProblemTypes = List((1, "Lists"), (2, "Arithmetic"), (3, "Binary Trees"), (4, "Multiway Trees"), (5, "Graphs"),
    (6, "Miscellaneous"))
  val ListProblems = List((1, "Last Element"), (2, "Penultimate Element"))
  ...
  def getUserChoice(options: List[(Int, String)]): Int = {
    ...
    val firstQuestionNumber = options(0)._1
    ...
    breakable {
      while (true) {
        ...
        else println(s"Please enter a valid numbet between $firstQuestionNumber and $lastQuestionNumber")
      }
    }
    choice.get
  }
